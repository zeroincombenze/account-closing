...
=====================================
|icon| Fiscal year closing 10.0.1.2.0
=====================================
...
::
    ...
    deploy_odoo clone -r account-closing -b 10.0 -G zero -p $HOME/10.0
...
::
    ...
    deploy_odoo update -r account-closing -b 10.0 -G zero -p $HOME/10.0
    vem amend $HOME/10.0/venv_odoo
...
.. |Maturity| image:: https://img.shields.io/badge/maturity-Alfa-black.png
    ...
    :alt: 
.. |Build Status| image:: https://travis-ci.org/zeroincombenze/account-closing.svg?branch=10.0
...
.. |license opl| image:: https://img.shields.io/badge/licence-OPL-7379c3.svg
    ...
    :alt: License: OPL
.. |Coverage Status| image:: https://coveralls.io/repos/github/zeroincombenze/account-closing/badge.svg?branch=10.0
    :target: https://coveralls.io/github/zeroincombenze/account-closing?branch=10.0
    :alt: Coverage
.. |Codecov Status| image:: https://codecov.io/gh/zeroincombenze/account-closing/branch/10.0/graph/badge.svg
    :target: https://codecov.io/gh/zeroincombenze/account-closing/branch/10.0
    :alt: Codecov
...
.. |Try Me| image:: https://www.zeroincombenze.it/wp-content/uploads/ci-ct/prd/button-try-it-10.svg
    ...
    :alt: Try Me
.. |OCA Codecov| image:: https://codecov.io/gh/OCA/account-closing/branch/10.0/graph/badge.svg
    :target: https://codecov.io/gh/OCA/account-closing/branch/10.0
    :alt: Codecov
